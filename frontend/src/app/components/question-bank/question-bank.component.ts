...
@Component({ selector: 'app-question-bank', standalone: true, imports: [DatePipe, RouterLink], templateUrl: './question-bank.component.html', styleUrl: './question-bank.component.scss' })
export class QuestionBankComponent implements OnInit {
  private questionBankService = inject(QuestionBankService); readonly busy = signal(false); readonly message = signal(''); readonly bank = signal<any>(null); ownerFile: File | null = null;
